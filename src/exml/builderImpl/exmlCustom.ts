import { components, common as comComps, properties } from "./exmlComponent";
...
export const compParse = (
   ...
   */
   export const getHead = (
       node: SceneNode
    ): { head: string, child: boolean, adaptive: boolean } => {
    let name = node.getPluginData("name")
    let comp = undefined
    ...
    return { head: head, child: child, adaptive: adaptive}
  }
